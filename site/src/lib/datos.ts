...
export const CATEGORIA_GASTO: Record<string, CategoriaGastoConfig> = {
	gastos_operacionales: {
		...
		campo: 'monto',
		unidad: '$',
		nota: 'Incluye arriendo de oficina, teléfono, traslación, difusión y otros ítems operacionales, sumados por camara.cl. Julio 2026 aparece en 0 para los 7 diputados porque la Cámara todavía no ha publicado ese mes — no es un gasto real de cero.',
	},
	asesorias_externas: {
		label: 'Asesorías externas',
		campo: 'monto',
		unidad: '$',
		nota: 'La página de asesorías externas de camara.cl no muestra tabla ni el mensaje habitual de "no publicado" para ningún diputado de la región: queda en blanco. Los 0 de esta tabla significan que no se pudo confirmar el dato, no que se haya verificado un gasto de cero.',
	},
	pasajes_aereos: {
		label: 'Pasajes aéreos nacionales',
		campo: 'cantidad',
		unidad: 'vuelos',
		nota: 'camara.cl publica el registro de cada vuelo (fecha, pasajero, tramo, aerolínea) pero no su costo — por eso esta tabla muestra la cantidad de vuelos del mes, no un monto en pesos.',
	},
	personal_apoyo: {
		label: 'Personal de apoyo',
		campo: 'monto',
		unidad: '$',
		nota: 'Gasto mensual total en sueldos del personal de apoyo contratado por cada diputado/a, publicado y verificado en camara.cl.',
	},
};
...
/** Datos hasta julio de 2026 (agosto todavía no está publicado por camara.cl). */
